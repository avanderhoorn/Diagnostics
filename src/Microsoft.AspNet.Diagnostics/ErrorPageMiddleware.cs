...
namespace Microsoft.AspNet.Diagnostics
{
    ...
    /// </summary>
    public class ExceptionHandlerAndDisplayPageMiddleware
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExceptionHandlerAndDisplayPageMiddleware"/> class
        /// </summary>
        /// <param name="next"></param>
        /// <param name="options"></param>
        public ExceptionHandlerAndDisplayPageMiddleware(
            ...
            IApplicationEnvironment appEnvironment)
        {
            _next = next;
            _options = options;
            _logger = loggerFactory.CreateLogger<ExceptionHandlerAndDisplayPageMiddleware>();
